...
var filePluginConfig = {copy:[], archive:[], delete:[]};
...
var normalConfig = {
    ...
    module: {
        rules: [
            ...
            {
                test: /\.(png|mp3|jpg|jpeg|m4a|ttf|otf|gif|woff|svg)$/,
                exclude: /models/,
                loader: 'url-loader',
...
if(isProduction){
    normalConfig.optimization = normalConfig.optimization || {};

    if(hideConsolesOnBuild){
        normalConfig.optimization.minimizer = [
            new TerserPlugin({
